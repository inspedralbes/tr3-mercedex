        ...
        <div class="w-[90%] h-[800px] grid grid-cols-3 gap-4">
            <div class="relative rounded-md overflow-hidden">
                <img class="w-full h-full object-cover brightness-75"
                    src="https://cflvdg.avoz.es/sc/imlGZ3AQzKC3vWRvTL8_Uaiw4pc=/1280x/2021/02/11/00121613072762898436844/Foto/j29e1016.jpg"
                    alt="">
                    <div class="w-3/4 absolute bottom-5 left-5">
                        <h3 class="text-2xl font-semibold">Mercedes EQA</h3>
                        <p class="text-sm">Tambien, para afrontar trayectos largos</p>
                    </div>
            </div>
            <div class="flex flex-col gap-4">
                <div class="h-1/2 relative rounded-md overflow-hidden">
                    <img class="w-full h-full object-cover brightness-75"
                        src="https://www.auto-revista.com/images/showid2/5933499?w=900&mh=700" alt="">
                    <div class="w-3/4 absolute bottom-5 left-5">
                        <h3 class="text-2xl font-semibold">Nuevos coches de stock disponibles</h3>
                        <p class="text-sm">En un click llevate tu Mercedes nuevo con entrega inmediata</p>
                    </div>
                </div>
                <div class="h-1/2 relative rounded-md overflow-hidden">
